<template>
    <el-card @click="goDetail" style="max-width: 480px" shadow="hover">
        <div class="content">
            <div class="left">
                <div class="name">
                ...
                <div class="tip">
                    <div class="level">
                        <svg t="1730168464469" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="4413" width="16" height="16">
                            <path
                    ...
                    <div class="time">
                        <svg t="1730168538015" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="5540" width="16" height="16">
                            <path
